...
data class RoutePost(var routeName:String, var like:Int,var docId: String ,var ownerId:String, var ownerName:String,var option:List<String>, var isLiked: Boolean = false )
